...
description: Aksesibilitas itu bukan hanya tentang aplikasi web dan ponsel, tetapi juga untuk file format paling popular di muka bumi, Portable Document Format (PDF).
category: ["Accessibility"]
tags: ["a11y", "pdf", "testing", "inclusive design"]
lang: id
thumbnail: memilih-alat-pengujian-aksesibilitas-dokumen-pdf.png
---
